...
- [BlockChoice (no native selects)](blockchoice-no-native-selects.md) — frontend has NO native <select>; all dropdowns use inline BlockChoice radiogroup; required fields validate in submit handler via iosAlert.
